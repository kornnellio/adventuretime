...
export const metadata: Metadata = {
  title: "Înregistrare - AdventureTime.Ro",
  description: "Creează un cont nou pe AdventureTime.Ro",
};
      ...
      <div className="relative w-full max-w-md z-10 px-4">
        <div className="relative w-full rounded-xl border bg-background/90 p-8 shadow-[0_20px_50px_rgba(8,_112,_184,_0.2)] backdrop-blur-md transition-all duration-300 hover:shadow-[0_20px_60px_rgba(8,_112,_184,_0.3)]">
          <div className="space-y-3 text-center">
            <h1 className="text-3xl font-bold tracking-tight text-foreground bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">Creează un cont</h1>
            <p className="text-muted-foreground">
              Introduceți datele pentru a vă crea contul
            </p>
          </div>
          <RegisterForm />
